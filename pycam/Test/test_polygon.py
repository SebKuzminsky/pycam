...
def test_get_offset_polygons_truncated_square_inside_small_offset():
    ...
    # 'expected_inside_p' is the expected offset polygon with a *negative*
    # offset, so it's inside the input polygon.
    lines = (Line((1.4142135623730951, 1.0, 0.0), (18.585786437626904, 1.0, 0.0)),
             Line((18.585786437626904, 1.0, 0.0), (19.0, 1.4142135623730951, 0.0)),
             Line((19.0, 1.4142135623730951, 0.0), (19.0, 8.585786437626904, 0.0)),
             Line((19.0, 8.585786437626904, 0.0), (18.585786437626904, 9.0, 0.0)),
             Line((18.585786437626904, 9.0, 0.0), (1.4142135623730951, 9.0, 0.0)),
...
def test_get_offset_polygons_truncated_square_inside_big_offset():
    ...
    # 'expected_inside_p' is the expected offset polygon with a *negative*
    # offset, so it's inside the input polygon.
    lines = (Line((3.0, 3.0, 0.0), (17.0, 3.0, 0.0)),
             Line((17.0, 3.0, 0.0), (17.0, 7.0, 0.0)),
             Line((17.0, 7.0, 0.0), (3.0, 7.0, 0.0)),
